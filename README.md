...
- **Equipment/loot**: killing Nonna Fury drops one random **Epic** item (Head, Shoulders, Chest, or Legs) at a glowing pedestal near her — walk into it to auto-equip. Each slot grants a stat bonus (Head/Chest: bonus max health, Shoulders: bonus sword/bow damage, Legs: bonus move speed), visibly welds a colored piece onto your character, and persists through respawns. Click the **"Character"** button (top-right of the screen) or press **C** to open/close a WoW-style character panel listing what's equipped in each of the 4 slots — click an equipped item's row to pop open a stats window with its exact stat bonus (e.g. "+30 Max Health"); click the row again or the popup's **X** to close it. The world loot pedestal also shows the stat line beneath the item name before you pick it up. Nonna Fury respawns 20 seconds after death so the boss (and its loot) is farmable.
