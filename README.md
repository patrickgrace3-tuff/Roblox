...
- A third **dungeon** zone (further along X, its own `DungeonSpawn`) is a torch-lit stone corridor: grab the **sword and shield** from the weapon rack near the entrance, then **left click** to swing your sword (melee range, damages whatever's roughly in front of you) and hold **right click** to raise your shield (reduces incoming damage by 60%). A health bar shows bottom-left. Chasing mobs are scattered down the corridor, and the corridor ends in a boss room guarded by **Nonna Fury**, an oversized angry chef wielding a giant spoon — defeating her spawns a golden victory pedestal.
